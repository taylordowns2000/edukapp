...
public class WookieServerConfiguration {
	...
	private WookieServerConfiguration(){
		try {
			...
			if (properties.containsKey("wookie.server.username")) username = properties.getString("wookie.server.username");
			if (properties.containsKey("wookie.server.password")) password = properties.getString("wookie.server.password");
