$(document).ready(function () {
  ...
  $.getJSON('api/featured', function (data) {
    ...
    for (var i=0;i<data.length;i++){
        ...
        $(div).append("<div class='pull-left' style='padding:10px'><h3>"+data[i].widgetProfile.name+"</h3><p>"+data[i].widgetProfile.description+"</p><p><a class='btn btn-inverse' href='widget.jsp?id="+data[i].widgetProfile.id+"'>Read more</a></p></div>");
