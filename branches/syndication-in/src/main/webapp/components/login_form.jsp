<form method="POST" id="login_form" action="/login" class="form-inline" style="display: none; margin-bottom: 0; margin-left: 15px">
  ...
  <input autocomplete="off" id="name" name="username" type="text" class="input-small" placeholder="user name">
