...
public class UploadServlet extends HttpServlet {
  ...
  private int intMaxFileUploadSize = 25 * 1024 * 1024;//25 mb is more than enough
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (ServletFileUpload.isMultipartContent(request)) {//file attached =>widget invoke wookie/widgets rest service
    	...
    	try {
      		...
      		for(FileItem fileItemCurrent : listFileItems) {
      			...
      			if (fileItemCurrent.isFormField()) {
      				...
      				log.info("request string part:"+fileItemCurrent.getFieldName()+":"+fileItemCurrent.getString());
      		...
      		PostMethod postMethod = new PostMethod("http://localhost:8080/wookie/widgets");
